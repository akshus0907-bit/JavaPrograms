/*Question 51: A study has shown that playing a musical instrument helps in increasing one's IQ by 7 points.
...
Input Output
165 Yes
Explanation : After learning a musical instrument, Chef's final IQ will be 165+7=172. Since 172 >= 170 Chef can beat Einstein.
Input Output
120 No
Explanation: After learning a musical instrument, Chef's final IQ will be 120+7=127. Since 127 < 127<170, Chef cannot beat Einstein.*/

import java.util.*;
public class Musical{
	public static void main(String[]args){
		Scanner in=new Scanner(System.in);
		System.out.println("enter IQ of the chef");
		int a=in.nextInt();
		int sum=a+7;
		if(sum>170){
