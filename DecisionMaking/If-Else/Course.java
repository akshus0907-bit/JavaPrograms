/*Question 50: There is a group of NN friends who wish to enroll in a course together. The course has a maximum capacity of MM students 
that can register for it. If there are KK other students who have already enrolled in the course, 
...
public class Course{
	public static void main(String[]args){
		...
		System.out.println("enter friends who wish to enroll in a course together");
		int a=in.nextInt();
		System.out.println(" maximum capacity of  students");
		int b=in.nextInt();
		System.out.println("students who have already enrolled in the course");
		int c=in.nextInt();
