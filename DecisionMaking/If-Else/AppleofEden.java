...
The first line will contain TT, the number of test cases. Then the test cases follow.
 Each test case contains a single line of input, two integers XX and YY.
 Output Format
...
public class AppleofEden{
	public static void main(String[]args){
		...
		System.out.println("enter number of guards with the apple of Eden and enter  number of guards");
		int eden =in.nextInt();
		int guard=in.nextInt();
		if(eden<guard){
